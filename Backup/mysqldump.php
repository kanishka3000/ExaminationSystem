...
if( isset($_REQUEST['action']) )
{
	...
	else if( 'Export' == $_REQUEST['action'])
	{
		...
		if( 'SQL' == $_REQUEST['output_format'] )
		{
            ...
            echo "create database UCSCEXAM;";echo "use UCSCEXAM;";
...
<html>
<head>
<title>Admin Backup Database::mysqldump.php version <?php echo $mysqldump_version; ?></title>
</head>
...
<table border="0">
  ...
  <tr>
<!--<?php //echo $_REQUEST['mysql_database']; ?>-->
<td><!--Database:--></td>
    <td><input  name="mysql_database" value="UCSCEXAM" type="hidden" /></td>
  </tr>
  <tr>
    <td>Username:</td>
