...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">
    <head>
        <title>Admin-Active course reports</title>
...
<li><a href="AdminAddBackup.php">Back Up Database</a></li>
                ...
                <div id="stuff">
                <br /><br /><br /><br /><br /><br />
                    select the course type you want to get the report
                    <form action="Script/AAdminActiveCourseReport.php">
                    <select name="type">
                        <option>Active</option>
                        <option>Inactive</option>
                        <option>AllExisting</option>
                    </select>
