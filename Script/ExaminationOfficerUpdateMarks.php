...
//    print_r($examination);
    ...
    foreach($subjects as $subject){
        ...
        $sheet->write(4,0,"Index No:",$HeadFormat);
        ...
        if(is_array($marks)){
            foreach($marks as $mark){
                ...
                $PaperMarks=$mark->Paper;
                $AssMark=$mark->Assignment;
                $AttMark=$mark->AttendanceMk;
                $shshy=$mark->Shy;
                ...
                $sheet->write($i,1,"$Rename");
                    $sheet->write($i,2,"0");
                            $sheet->write($i,3,"0");
                            $sheet->write($i,4,"0");
                            $sheet->write($i,5,$PaperMarks);
                $sheet->write($i,6,$AssMark);
                $sheet->write($i,7,$AttMark);
...
//        echo 'ERROR: Could not save spreadsheet.';
   // }
    ...
    header("location:../Confirmation/ExaminationOfficerUpdateMarks.php");
