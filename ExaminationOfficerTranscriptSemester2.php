    ...
    <body >
        ...
        <div id="wrapper">
            ...
            <div id="content">
                ...
                <form action="Script/ExaminationOfficerTranscriptSemester2.php">
                    <div id="stuff">
                  <input type="hidden" name="final" value="final"/>
                  <b>  Please Select the Students Requesting for semesterwise Report</b><br/>
                    Repeating the process will genarate multiple reports with redundant data.The report contains information on each semester
                    <table border="1">
                    <tr>
