...
<div id="main">
	<div id="welcome" class="post">
	  ...
	  <div class="story">
	    ...
	    <div id="apDiv27">
  <fieldset>
  <legend class="style3 style5">Add a note</legend>
  <form id="form1" name="form1" method="post" action="">
    <label for="NoteTextarea"></label>
    <p>
      <textarea name="NoteTextarea" id="NoteTextarea" cols="45" rows="5"></textarea>
    </p>
    <p>
      <label for="SubmitBtn"></label>
      <input type="submit" name="SubmitBtn" id="SubmitBtn" value="Add Note" />
    </p>
  </form>
  <p>&nbsp;</p>
  </fieldset>
